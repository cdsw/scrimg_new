...
class Trainer:
    def __init__(self, img_size, annotation_path='mokemify/annotation.txt',
        ...
        num_val, num_train = self.randomize_annnotations()
    ...
    def train(self, num_val, num_train):
        ...
        if True:
            ...
            self.model.fit_generator(
                self.data_generator_wrapper(lines[:num_train], batch_size, self.input_shape, self.anchors, self.num_classes),
