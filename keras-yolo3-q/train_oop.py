...
class Trainer:
    def __init__( self ):
        self.annotation_path = 'scrimg_train.txt'
        self.log_dir = 'logs/'
        self.classes_path = 'model_data/scrimg_classes.txt'
        self.anchors_path = 'model_data/scrimg_anchors.txt'
        ...
        self.img_sh = 352
        self.input_shape = (self.img_sh, self.img_sh)  # multiple of 32, hw
