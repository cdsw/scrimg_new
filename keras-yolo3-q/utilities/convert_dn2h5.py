...
class ModelConverter:
    def __init__(self, version, cfg_path, wt_path, out_path, output_img):
    ...
    def convert(self):
        ...
        assert self.weights_path.endswith(
            '.weights'), '{} is not a .weights file'.format(self.weights_path)
        ...
        unique_config_file = ModelConverter.unique_config_sections(self.config_path)
        ...
        if weights_only:
            ...
            model.save('{}'.format(self.output_path))
