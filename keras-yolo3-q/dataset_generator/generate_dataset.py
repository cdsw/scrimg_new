...
class DatasetGenerator:
    def __init__(self):
        ...
        self.wordDirs = ['./words/latnWords.txt', './words/thaiWords.txt', './words/kornWords.txt']
        self.fontDirs = ['./fonts/Latin/', './fonts/Thai/', './fonts/Korean/']
    ...
    def generateAnnotation(filename, script_class, topLeft, bottomRight):
        ...
        filename = './dataset_generator' + filename[1:]
    ...
    def generateImage(self, scriptChoice, mode):
        ...
        # ==============================
        filename = "./output/" + self.scriptCodes[scriptChoice] + "_" + \
                   str(self.imgCount + self.countOffset).zfill(5) + ".jpg"
        img.save(filename)
