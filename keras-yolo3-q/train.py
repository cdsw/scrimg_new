...
class Trainer:
    def __init__(self, img_size, version, annotation_path='dataset_generator/annotation.txt',
        ...
        self.anchors_path = 'model_data/scrimg_anchors-'+version+'.txt'
        self.model_path = 'model_data/yolo-'+version+'.h5'
    ...
    def train(self, num_val, num_train, num_epoch_init, num_epoch):
        ...
        if True:
            ...
            self.model.fit_generator(
                ...
                validation_data=self.data_generator_wrapper(self.lines[num_train:], batch_size, self.input_shape, self.anchors,
                                                       self.num_classes),
                validation_steps=max(1, num_val // batch_size),
                epochs=num_epoch_init,
                initial_epoch=0,
